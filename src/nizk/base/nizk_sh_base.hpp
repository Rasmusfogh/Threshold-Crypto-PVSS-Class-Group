...
namespace NIZK
{
    ...
    class Nizk_SH_base : public Nizk_base<Witness, Statement...>  {
        ...
        protected:
            ...
            const vector<unique_ptr<Mpz>>& Vis_;

        public:
            Nizk_SH_base(HashAlgo& hash, RandGen& rand, const CL_HSMqk& cl, const Mpz& q, 
                const size_t& n, const size_t& t, const vector<unique_ptr<Mpz>>& Vis)
